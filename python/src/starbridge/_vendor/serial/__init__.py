...
# pySerial uses absolute ``serial.*`` imports internally. Register this private
# vendored package under its upstream name before those imports are evaluated.
sys.modules.setdefault('serial', sys.modules[__name__])
